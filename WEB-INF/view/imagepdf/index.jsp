...
<form name="fileuploadform" action="/itext-sample/imagepdf/pdf" method="post" enctype="multipart/form-data" onsubmit="tryOnce();" >
<div class="centering">
<p>
...
<a href="/itext-sample/imagepdf/" >リトライ</a><br/>
</div>
</p>
</div>
</form>
